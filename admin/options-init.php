...
if (!class_exists('growth_Redux_Framework_config')) {

    class growth_Redux_Framework_config {
...
// SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    ...
    global $reduxConfig;
    $reduxConfig = new growth_Redux_Framework_config();
}

/**
  Custom function for the callback referenced above
 */
if (!function_exists('growth_my_custom_field')):
    function growth_my_custom_field($field, $value) {
        print_r($field);
        echo '<br/>';
        print_r($value);
    }
 ...
 * */
if (!function_exists('growth_validate_callback_function')):
    function growth_validate_callback_function($field, $value, $existing_value) {
        $error = false;
        $value = 'just testing';
